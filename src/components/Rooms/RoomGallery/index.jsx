...
const RoomGallery = () => {
    return (
      <div className="flex flex-col items-center max-w-[1440px] w-[90%] mx-auto justify-start gap-10 my-[5rem]">
        ...
        <div className="flex flex-row justify-start items-start w-full gap-7 md:gap-2 ">
          <div className="flex flex-col items-center justify-start w-[49%] gap-7 md:gap-2 ">
            <Img
          ...
          <div className="flex flex-col items-center justify-start w-[49%] mt-[148px] gap-7 md:gap-2 ">
            <Img
